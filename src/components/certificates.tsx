      ...
      <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-[16px] px-6 lg:px-0">
        ...
        <div className="flex w-full items-center justify-between gap-[16px]">
          {certificates.map((cert) => (
            <div
              key={cert.src}
              className="group relative flex h-[204px] w-[204px] shrink-0 flex-col items-center justify-center gap-[16px] overflow-hidden rounded-[43.2px] border-[0.8px] border-[rgba(42,51,64,1)] bg-[rgba(19,24,32,1)] px-[24px] py-[22px] transition-all hover:border-[rgba(56,189,248,0.4)] hover:shadow-[0_0_24px_rgba(56,189,248,0.08)]"
            >
